...
namespace TechedRazor.Services.ApiServices.Impl
{
    public class PublicApiService : IPublicApiService
    {
        ...
        private readonly string apiQueryString = "markets?vs_currency=usd&order=market_cap_desc&per_page=100&locale=en";
        ...
        public async Task<IList<CoinDTO>> GetCoinList()
        {
            ...
            _coinList = JsonConvert.DeserializeObject<List<CoinDTO>>(jsonResponse);
